//-------------------------------------------------------------------------------
// <copyright file="StateMachineBase.cs" company="Appccelerate">
...
namespace Appccelerate.StateMachine
{
    ...
    public class StateMachineBase<TState, TEvent> : IStateMachineInformation<TState, TEvent>, INotifier<TState, TEvent>, IExtensionHost<TState, TEvent> where TState : IComparable
        where TEvent : IComparable
    {
        ...
        protected StateMachineBase(string name, IFactory<TState, TEvent> factory)
        {
            this.name = name;
