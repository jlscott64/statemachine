...
namespace Appccelerate.StateMachine.Machine
{
        ...
        where TEvent : IComparable
    {
        ...
        public StandardFactory(INotifier<TState, TEvent> notifier)
        {
        ...
        {
            return new State<TState, TEvent>(id, this.notifier);
        }

        public virtual ITransition<TState, TEvent> CreateTransition()
        {
            return new Transition<TState, TEvent>(this.notifier);
        }
        ...
        public virtual ITransitionContext<TState, TEvent> CreateTransitionContext(IState<TState, TEvent> state, Missable<TEvent> eventId, object eventArgument)
        {
